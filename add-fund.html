...
// Admin credentials
$adminPassword = "1111"; // Replace with the actual admin password
$adminUsers = "naphmk";// List of admin usernames
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  confirmButtonText: 'OK'
        ...
        if ($result->num_rows > 0) {
            ...
            $updateQuery = "UPDATE users SET wallet_balance = wallet_balance + $amount WHERE username = '$username'";
            if ($conn->query($updateQuery)) {
                echo "<script>
                 Swal.fire({
  title: 'Funded',
  text: '$username has been Funded with $amount',
  icon: 'success',
  confirmButtonText: 'OK'
}).then((isOkay)=>{
            if (isOkay){
...
<html lang="en">
  <head>
    ...
    <title>Nova Pay | Fund-Customer</title>
    <link
      ...
      >
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            <h1 class="text-xl font-semibold text-center">Fund Customer's Wallet</h1>
            <form action="#" method="POST" class="space-y-6" onsubmit="return submitForm(this);">
              ...
              />
                ...
                <a href="../admin/add-fund.php"><button
                  type="submit"
