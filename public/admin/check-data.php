...
<html lang="en">
  ...
  <body class="bg-blue-900 text-white font-sans">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- Page Header -->
      <h1 class="text-3xl font-bold mb-6 text-center">Check Data</h1>
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="bg-blue-700">
              ...
              <th class="px-4 py-2 border-b text-sm font-medium">Gateway Trans ID</th>
              ...
              <th class="px-4 py-2 border-b text-sm font-medium">Amount Deducted</th>
              <th class="px-4 py-2 border-b text-sm font-medium">Gateway Deducted</th>
              ...
              <th class="px-4 py-2 border-b text-sm font-medium">API Response</th>
            </tr>
          </thead>
          <tbody id="table-body">
    ...
    <script>
      ...
      const totalRows = 10; // Total dummy rows
      let rows = [];
      ...
      const generateRows = (numRows) => {
        const username = ["Naph", "Muhd", "Kamal", "MDEE"];
        ...
        for (let i = 1; i <= numRows; i++) {
          tableRows.push(`
            <tr class="odd:bg-blue-800 even:bg-blue-700 hover:bg-blue-600">
               <td class="px-4 py-2 border-b">${username[Math.floor(Math.random() * username.length)]}</td>
              ...
              <td class="px-4 py-2 border-b">₦${Math.floor(Math.random() * 100000 + 5000)}</td>
              <td class="px-4 py-2 border-b">₦${Math.floor(Math.random() * 100000 + 10000)}</td>
